...
// This is a class component because of the library
// wont bother to refactor it to functional
class SelectPersonClass extends PureComponent {
  state = {
    showBtn: 'none',
    loading: true,
    src: '',
  ...
  updateVideoPerson = async () => {
    ...
    setTimeout(() => {
      this.props.navigate('/user/videos');
    }, 1000);
  };
...
function SelectPerson(props) {
  ...
  return <SelectPersonClass {...props} navigate={navigate} />;
}
